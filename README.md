...
[![demo](./public/demo.gif)](https://drive.google.com/file/d/1HTS9uhVRvx0vf0APoUijMUbRd9iLnPqu/view?usp=sharing)

The software stack simulates sensor readings and device–cloud communication with a Go backend and Svelte frontend,
containerized with Docker and made reproducible via Nix.
An OpenAPI specification defines the backend API, enabling consistent client generation.
...
flowchart TD
    subgraph machine[Machine]
        frontend --Machine Interface IP--> localMachineNetworkBridge --CORS--> backend
        localMachineNetworkBridge[Machine Interface]
        subgraph docker[Docker]
            dockerNetworkBridge[Docker Interface]
            ...
            simulation --> dockerNetworkBridge --> backend
